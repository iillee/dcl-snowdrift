...
import { SHOW_SERVER_STATS, SHOW_SKYBOX_DEBUG, SHOW_TORCH_WARMTH_DEBUG }  from 'src/client/devFlags'
...
import { skyboxDebugLayer }      from 'src/client/ui/layers/layer.skyboxDebug'
...
export function setupUi() {
	...
	if (SHOW_SKYBOX_DEBUG)       devLayers.push(skyboxDebugLayer)
